          ...
          <div className="flex min-h-0 flex-1 flex-col bg-background">
            ...
            <main className="relative isolate flex min-h-0 flex-1">
              <div className="hidden min-h-0 flex-1 md:flex">
                ...
                >
                  {/* Left Panel - Chat - Toggleable */}
                  <div 
                    className={`relative inset-y-0 z-40 mr-0 flex h-full min-h-0 overflow-x-hidden bg-background border-r border-border transition-all duration-300 ease-in-out ${
                      showChat ? 'w-96 opacity-100' : 'w-0 opacity-0 overflow-hidden'
                    }`}
                    data-panel=""
                  >
                    {showChat && (
                  ...
                  {/* Resizer - only show when chat is visible */}
                  {showChat && (
                    <div 
                  ...
                  <div 
                    ...
                    style={{flexBasis: "0", flexGrow: showChat ? "70.0" : "100.0", flexShrink: "1", overflow: "hidden"}}
                    data-panel=""
                  >
                    <div className="flex flex-grow flex-col overflow-hidden rounded-xl border bg-background">
                      {/* Manim Editor Interface */}
